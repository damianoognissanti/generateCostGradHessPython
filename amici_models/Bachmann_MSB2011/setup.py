...
def get_extension() -> Extension:
    ...
    sources = [os.path.join("swig", "Bachmann_MSB2011.i"), *get_model_sources()]
    ...
    # Build shared object
    ext = Extension(
        'Bachmann_MSB2011._Bachmann_MSB2011',
        sources=sources,
        include_dirs=ext_include_dirs,
        libraries=libraries,
        library_dirs=ext_library_dirs,
        swig_opts=[
            '-c++', '-modern', '-outdir', 'Bachmann_MSB2011',
...
# Install
setup(
    name='Bachmann_MSB2011',
    cmdclass=CMDCLASS,
    version='0.1.0',
    description='AMICI-generated module for model Bachmann_MSB2011',
